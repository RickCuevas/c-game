...
class T_VIEW_EXPORT layouts_gameView : public TActionView
{
  Q_OBJECT
public:
  Q_INVOKABLE
  layouts_gameView() : TActionView() { }
  QString toString();
};

QString layouts_gameView::toString()
{
  responsebody.reserve(928);
...
T_DEFINE_VIEW(layouts_gameView)

#include "layouts_gameView.moc"
