...
QT_MOC_LITERAL(8, 54, 4), // "show"
QT_MOC_LITERAL(9, 59, 2), // "id"
QT_MOC_LITERAL(10, 62, 6), // "create"
QT_MOC_LITERAL(11, 69, 4), // "save"
QT_MOC_LITERAL(12, 74, 6) // "remove"

    },
    "BlogController\0index\0\0welcome\0loop\0"
    "start\0battle\0equip\0show\0id\0create\0"
    "save\0remove"
};
...
void BlogController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::CreateInstance) {
        ...
        case 6: _t->show((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 7: _t->create(); break;
        case 8: _t->save((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 9: _t->remove((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
